...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgIData(oldp+34,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[0]),32);
        bufp->chgIData(oldp+35,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[1]),32);
        bufp->chgIData(oldp+36,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[2]),32);
        bufp->chgIData(oldp+37,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[3]),32);
        bufp->chgIData(oldp+38,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[4]),32);
        bufp->chgIData(oldp+39,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[5]),32);
        bufp->chgIData(oldp+40,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[6]),32);
        bufp->chgIData(oldp+41,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[7]),32);
        bufp->chgIData(oldp+42,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[8]),32);
        bufp->chgIData(oldp+43,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[9]),32);
        bufp->chgIData(oldp+44,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[10]),32);
        bufp->chgIData(oldp+45,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[11]),32);
        bufp->chgIData(oldp+46,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[12]),32);
        bufp->chgIData(oldp+47,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[13]),32);
        bufp->chgIData(oldp+48,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[14]),32);
        bufp->chgIData(oldp+49,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[15]),32);
        bufp->chgIData(oldp+50,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[16]),32);
        bufp->chgIData(oldp+51,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[17]),32);
        bufp->chgIData(oldp+52,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[18]),32);
        bufp->chgIData(oldp+53,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[19]),32);
        bufp->chgIData(oldp+54,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[20]),32);
        bufp->chgIData(oldp+55,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[21]),32);
        bufp->chgIData(oldp+56,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[22]),32);
        bufp->chgIData(oldp+57,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[23]),32);
        bufp->chgIData(oldp+58,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[24]),32);
        bufp->chgIData(oldp+59,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[25]),32);
        bufp->chgIData(oldp+60,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[26]),32);
        bufp->chgIData(oldp+61,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[27]),32);
        bufp->chgIData(oldp+62,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[28]),32);
        bufp->chgIData(oldp+63,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[29]),32);
        bufp->chgIData(oldp+64,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[30]),32);
        bufp->chgIData(oldp+65,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf[31]),32);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        bufp->chgIData(oldp+66,(vlSelf->top__DOT__if_id_pc),32);
        bufp->chgCData(oldp+67,((0x7fU & vlSelf->top__DOT__if_id_pc)),7);
        bufp->chgCData(oldp+68,((7U & (vlSelf->top__DOT__if_id_pc 
                                       >> 0xcU))),3);
        bufp->chgSData(oldp+69,((vlSelf->top__DOT__if_id_pc 
                                 >> 0x14U)),12);
        bufp->chgCData(oldp+70,((0x1fU & (vlSelf->top__DOT__if_id_pc 
                                          >> 7U))),5);
        bufp->chgCData(oldp+71,((0x1fU & (vlSelf->top__DOT__if_id_pc 
                                          >> 0xfU))),5);
    }
    bufp->chgBit(oldp+72,(vlSelf->clk));
    bufp->chgBit(oldp+73,(vlSelf->rst));
    bufp->chgIData(oldp+74,(vlSelf->npc_data),32);
    bufp->chgIData(oldp+75,(vlSelf->top__DOT__idu0__DOT__Reg0__DOT__rf
                            [(0x1fU & (vlSelf->top__DOT__if_id_pc 
                                       >> 0xfU))]),32);
    bufp->chgIData(oldp+76,(vlSelf->top__DOT__ex_id_src1),32);
    bufp->chgIData(oldp+77,(vlSelf->top__DOT__ifu0__DOT__pc_rom),32);
}
