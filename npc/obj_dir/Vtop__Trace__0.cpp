...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgSData(oldp+37,((vlSelf->top__DOT__if_id_pc 
                                 >> 0x14U)),12);
        bufp->chgIData(oldp+38,(((4U >= (7U & (vlSelf->top__DOT__if_id_pc 
                                               >> 0xfU)))
        ...
        bufp->chgIData(oldp+47,(vlSelf->top__DOT__ifu0__DOT__pc_rom),32);
    }
    bufp->chgBit(oldp+48,(vlSelf->clk));
    bufp->chgBit(oldp+49,(vlSelf->rst));
    bufp->chgIData(oldp+50,(vlSelf->npc_data),32);
}
